...
$(document).ready(function(){
    ...
    try{
        ...
        window.iApplicationUser+=1;
        window.iApplication=0;
        svgApplicationIndex = window.iApplication;
        userApplicationIndex = window.iApplicationUser;
        svg = d3.select("#rightApplicationSVG"+userApplicationIndex+svgApplicationIndex),
        margin = 20,
        diameter = +svg.attr("width"),
        g = svg.append("g").attr("transform", "translate(" + diameter / 2 + "," + diameter / 2 + ")");
    ...
    var root = window['jsondata_application'+userApplicationIndex+svgApplicationIndex];
        window.iApplication=window.iApplication+1;
