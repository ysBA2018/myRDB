...
$(document).ready(function(){
    var svgDeletionIndex = window.iUnansweredDelete;
    var svg, margin, diameter, g;

    svg = d3.select("#unansweredDeletionSVG"+svgDeletionIndex),
    margin = 20,
    ...
    var root = window['jsondata_unanswered_delete'+svgDeletionIndex];
    if(root == null){
        root = {'name':'doesnt exist','size' : 2000}
    }
        window.iUnansweredDelete=window.iUnansweredDelete+1;
