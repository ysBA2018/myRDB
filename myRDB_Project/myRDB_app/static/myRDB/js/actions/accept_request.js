function change_request_state_to_accepted_and_perform_action(formElement, current_card_id, current_user_collapse_id, current_user_id, content_div) {
...
function accept_clicked(d) {
  ...
  change_request_state_to_accepted_and_perform_action(form, current_card_id, current_user_collapse_id, current_user_id, content_div);
   return false;
}